...
void OnDataRecv(const uint8_t * mac, const uint8_t *incomingData, int len) {
  ...
  if (receiveFromReader.dataX == CLEAR_DISPLAY)
  {
    commandFromReader = CLEAR_DISPLAY;
  }
  if (receiveFromReader.dataX == SHOW_CARD)
  {
    Debug("ShowCard0");
    commandFromReader = SHOW_CARD;
    draw_card_suite = receiveFromReader.dataY;
    draw_card_value = receiveFromReader.dataZ;
  }
